...
$(document).ready(function () {
  ...
  // Image uploader
  $('.content-wrap .image-upload-wrap').on('click', 'button[name="uploadImage"]', function (e) {
    return $(e.target).prev('input[type="file"]').trigger('click');
  }).on('change', 'input[type="file"]', function () {
    var _this = this;
    var reader = new FileReader();
    reader.onload = function (e) {
      $(_this).closest('.image-upload-wrap').find('.image-upload-preview img').attr('src', e.target.result);
    };
